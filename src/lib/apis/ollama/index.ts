...
export const verifyOllamaConnection = (token: string = '', connection: dict = {}) =>
	apiFetch(`${OLLAMA_API_BASE_URL}/verify`, {
		method: 'POST',
		token,
		body: { ...connection }
	});
...
export const getOllamaConfig = (token: string = '') =>
	apiFetch(`${OLLAMA_API_BASE_URL}/config`, { token });
...
export const updateOllamaConfig = (token: string = '', config: OllamaConfig) =>
	apiFetch(`${OLLAMA_API_BASE_URL}/config/update`, {
		method: 'POST',
		token,
		body: { ...config }
	});
...
export const getOllamaUrls = async (token: string = '') => {
	const res = await apiFetch<{ OLLAMA_BASE_URLS: string[] }>(`${OLLAMA_API_BASE_URL}/urls`, {
		token
	});
...
export const updateOllamaUrls = async (token: string = '', urls: string[]) => {
	const res = await apiFetch<{ OLLAMA_BASE_URLS: string[] }>(
		`${OLLAMA_API_BASE_URL}/urls/update`,
