...
export const getModelAnalytics = async (
	...
	return apiFetch(`${WEBUI_API_BASE_URL}/analytics/models?${searchParams.toString()}`, { token });
};
...
export const getUserAnalytics = async (
	...
	return apiFetch(`${WEBUI_API_BASE_URL}/analytics/users?${searchParams.toString()}`, { token });
};
...
export const getMessages = async (
	...
	return apiFetch(`${WEBUI_API_BASE_URL}/analytics/messages?${searchParams.toString()}`, {
		token
	});
};
...
export const getSummary = async (
	...
	return apiFetch(`${WEBUI_API_BASE_URL}/analytics/summary?${searchParams.toString()}`, { token });
};
...
export const getDailyStats = async (
	...
	return apiFetch(`${WEBUI_API_BASE_URL}/analytics/daily?${searchParams.toString()}`, { token });
};
...
export const getTokenUsage = async (
	...
	return apiFetch(`${WEBUI_API_BASE_URL}/analytics/tokens?${searchParams.toString()}`, { token });
};
